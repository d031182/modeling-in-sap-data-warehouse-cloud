...
### Projection Node
With the projection node, you can exclude fields from your model. Hence, they won't be available nor consumpable on the client side, such as SAP Analytics Cloud. 
