...
9. Select on the _Output_ Node the Data Preview from the context menu. As a result you should be to view only data for **Company Code 9004**, which is maintained in the table **T_DAC_DATA**
