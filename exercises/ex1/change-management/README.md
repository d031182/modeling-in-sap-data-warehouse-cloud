...
>:blue_book: In short: **SAP Data Warehouse Cloud allows any kind of changes, while supporting users to resolve the issues and regain a consistent state for the models.**
