...
- [<h2>Exercise 3 - Internal Orders</h2>](exercises/ex3/)  
    - [<h3>Exercise 3.1 -Create Employee View</h3>](/exercises/ex3/employees-view)
        - Parent Child Hierarchy (Internal)  
    - [<h3>Exercise 3.2 - Create Vendor Product Category Hierarchy View</h3>](/exercises/ex3/vendor-product-category-hierarchy-view)
        - Parent Child Hierarchy (External) as a Hierarchy View
    - [<h3>Exercise 3.3 - Create Vendor Products View</h3>](/exercises/ex3/vendor-products-view)
